...
class SelectIndexHandler(AskUserEventHandler):
    ...
    def __init__(self, engine: Engine):
        """Sets the cursos to the player when this handler is constructed."""
...
class AreaRangedAttackHandler(SelectIndexHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        """Hightlights the tile under the cursor."""
        super().on_render(console)
...
class MainGameEventHandler(EventHandler):
    ...
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[ActionOrHandler]:
        ...
        elif key == tcod.event.KeySym.g or key == tcod.event.KeySym.COMMA:
...
class GameOverEventHandler(EventHandler):
    ...
    def on_quit(self) -> None:
        ...
        if os.path.exists("savegame.sav"):
            os.remove("savegame.sav") #Delets the active save file.
